...
export const ProductLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-[#798777]/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-[#BDD2B6]/15 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="inline-flex p-3.5 rounded-2xl bg-gradient-to-tr from-[#798777] to-[#BDD2B6] shadow-xl shadow-[#798777]/25 mb-4">
            <KeyRound className="w-7 h-7 text-[#111511]" />
          </div>
