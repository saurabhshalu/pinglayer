...
export const ApiKeyDisplay: React.FC<ApiKeyDisplayProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Warning Banner */}
      <div className="flex items-start gap-3 p-3.5 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-200">
      ...
      <div className="space-y-2">
        ...
        <div className="relative flex items-center bg-slate-950 rounded-xl border border-slate-700/80 p-3 shadow-inner">
          <code
        ...
        {onDismiss && (
          <div className="flex justify-end pt-1">
            <button
              ...
              onClick={onDismiss}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium bg-slate-800 text-slate-200 hover:bg-slate-700 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
